    ...
    <div class="container">
        ...
        <div class="right">
            <div class="login-container">
                <h2 style="margin-left: -243px">Masuk</h2>
                <h5 style="margin-left: -150px; margin-top:-20px; color:white" >Belum Punya Akun ? <a href="{{ url('/register') }}" style="text-decoration:none; color:#DC3545">Daftar</a></h5>
                <hr>
